...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        ## training flags
        self.parser.add_argument('--display_freq', type=int, default=500, help='frequency of showing training results on screen(iterations)')
        self.parser.add_argument('--update_html_freq', type=int, default=400, help='frequency of saving training results to html')
        self.parser.add_argument('--print_freq', type=int, default=50, help='frequency of showing training results on console(epochs)')
        ...
        self.parser.add_argument('--no_l1_loss', action='store_true', help='do not compute L1 loss')  
        self.parser.add_argument('--no_gan_loss', action='store_true', help='do not use GAN, only autoencoder') 
